    ...
    <body>
                ...
                <div class="owl-carousel">
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            <h3>Auto partes UPB</h3>
                            <h1>Renueva y asegura</h1>
                            <p>
                                Ofrecemos los mejores repuestos y partes necesarias para sus choces
                            </p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            <p>
                                Somos parte de uno de los consorcios de coches más grandes de toda colombia y contamos con respuetos para multiples modelos de coche 100% originales y sin uso previo. 
                            </p>
                            <ul>
                            ...
                            <a class="btn btn-custom" href="">Leer más</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="testimonial">
            <div class="container">
                <div class="section-header text-center">
                    <p>Testimonis</p>
                    <h2>Que dicen nustros clientes?</h2>
                </div>
